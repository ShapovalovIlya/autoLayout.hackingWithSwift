...
//
//  Created by Илья Шаповалов on 06.04.2022.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Auto layout VFL
//        //Creating dictionary with metrics
//        let metrics = ["LabelHeight": 88]
//
//        let viewsDictionary = ["label1": label1, "label2": label2, "label3": label3, "label4": label4, "label5": label5]
//        //Adding horizontal stack with format - H:|[...]| where "||" mean edge of the view controller and "[]" mean edge of the view
...
//        }
//        //Adding vertical stack with format - V:|[...]-... where "-" mean's space (10 poins by default)
